  ...
  return (
    <div>
      <div className="flex flex-col h-[100dvh] justify-center items-center">
        ...
        <div className="flex flex-col gap-1 fixed bottom-5 mx-[10%] rounded-[4px] w-fit p-3 border border-[#00000033] text-[14px]">
          <p className="font-[600]">Powered by veriqpro</p>
          <p className="font-[400]">Generating secure and unique product codes for your brand.</p>
        </div>
      </div>
    </div>
  );
